...
NSString * const MAIN_IMAGE_OBJ = @"_>main<_";

NSString * const GD_IOTD_PAGE_URL   = @"http://www.gamedev.net/gallery/category/2-iotd/";
NSString * const GD_POST_SEPARATOR  = @"<div class='gallery_album";

NSString * const GD_ARCHIVE_IOTD_PAGE_URL       = @"http://archive.gamedev.net/community/forums/gallery.asp?forum_id=62";
...
NSString * const KEY_DATE           = @"postDate";
NSString * const KEY_AUTHOR         = @"author";
NSString * const KEY_POST_URL       = @"url";
